...
class jomandjerryfactsIntentHandler(AbstractRequestHandler):
    """Handler for jomandjerryfactsIntent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("jomandjerryfactsIntent")(handler_input)
...
sb.add_request_handler(jomandjerryfactsIntentHandler())
