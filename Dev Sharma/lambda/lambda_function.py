...
class tomandjerryfactsHandler(AbstractRequestHandler):
    """Handler for tomandjerryfacts."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("tomandjerryfacts")(handler_input)
...
sb.add_request_handler(tomandjerryfactsHandler())
